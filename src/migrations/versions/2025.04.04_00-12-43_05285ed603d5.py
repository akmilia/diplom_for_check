...
Revision ID: 05285ed603d5
Revises: f9926303d830
Create Date: 2025-04-04 00:12:43.134967
...
def downgrade() -> None:
    ...
    sa.Column('idattendance', sa.INTEGER(), server_default=sa.text("nextval('attendance_idattendance_seq'::regclass)"), autoincrement=True, nullable=False),
